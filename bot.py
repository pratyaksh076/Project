...
developers_Q = ["Developers name","developers","who developed you ?","Who is your developer ?"]
developers_Ans = "My developers are:\n Chitransh Bhatnagar\n Ankit Sharma\n Rittik\n Pratyaksh Agarwal\n Ritika Bhardwaj"
...
# developers question
def developer(sentence) :
    for word in developers_Q:
        if sentence.lower() == word:
            return developers_Ans
...
def chat(user_response):
    ...
    if (user_response != 'bye'):
        if (user_response == 'thanks' or user_response == 'thank you'):
            ...
            elif (developer(user_response) != None):
                return (developer(user_response))
